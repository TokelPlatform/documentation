...
```bash
./tokel-cli addnode "192.168.0.6:8233" "onetry"
```
...
```bash
./tokel-cli disconnectnode "192.168.0.6:8233"
```
...
```bash
./tokel-cli getaddednodeinfo true
```
...
```bash
./tokel-cli getaddednodeinfo true "78.47.205.239"
```
...
```bash
./tokel-cli setban "192.168.0.6" "add" 86400
```
...
```bash
./tokel-cli setban "192.168.0.0/24" "add"
```
